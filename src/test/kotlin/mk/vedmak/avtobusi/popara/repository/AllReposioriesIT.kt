...
//    }
    ...
    fun insertCompleteLineWithCarrier() {
        ...
        val tra0101 = Trip("TRA0101", 1, 1, listOf(bt1315, re1405, oh1458), "TRA0101")
        val tra0201 = Trip("TRA0201", 1, 2, listOf(bt0630, re0720, oh0858, st0918), "TRA0201")
        val tra3901 = Trip("TRA3901", 1, 39, listOf(
        ...
        val jTra01 = Journey("TRA01", bitola, ohrid, listOf(tra0101))
        ...
        val tra01 = Line("TRA01", "Bitola - Ohrid", "Битола - Охрид",1, jTra01, schedule)
